...
Shader::Shader(const std::string& vertexSource, const std::string& fragmentSource)
    ...
    void Shader::Serialize(nlohmann::json& jsonData) const
    { 

       

        // Serialize vertex and fragment shader sources
        jsonData["vertexSource"] = vertexSource;
        jsonData["fragmentSource"] = fragmentSource;
    }
